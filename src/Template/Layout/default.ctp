    ...
    <body>
        <nav class="top-bar expanded" data-topbar role="navigation">
            ...
            <div class="top-bar-section">
                <ul class="right">
                    <li>
                        <?= $this->Html->link('Hotels', ['controller' => 'Hotels', 'action' => 'index']) ?>
                    </li>
                    <li>
                        <?php
                        ...
                        if ($loguser) {
                            $user = $loguser['email'];
                            echo '<li>';
                            echo $this->Html->link(__('Profil'), ['controller' => 'Users', 'action' => 'chercherInfo', $loguser['user_id']]);
                            echo '</li>';
                            echo '<li>';
                    ...
                    <li>
                        <?= $this->Html->link('Chinese', ['action' => 'changeLang', 'ch_HK'], ['escape' => false]) ?>
                    </li>
                    <li>
