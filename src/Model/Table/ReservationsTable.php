...
class ReservationsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('reserv_id');
        $this->setPrimaryKey('reserv_id');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('reserv_id')
            ->allowEmpty('reserv_id', 'create');

        $validator
            ->date('date_de')
            ->requirePresence('date_de', 'create')
            ->notEmpty('date_de');

        $validator
            ->date('date_a')
            ->requirePresence('date_a', 'create')
            ->notEmpty('date_a');

        $validator
            ->integer('nb_chambre')
            ->requirePresence('nb_chambre', 'create')
            ->notEmpty('nb_chambre');
